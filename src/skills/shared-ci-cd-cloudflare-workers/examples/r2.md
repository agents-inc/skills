...
> R2 bucket binding, file upload/download/delete, streaming, content-type handling, and list operations. Reference from [SKILL.md](../SKILL.md).
...
## Hono File Storage Service

An R2-backed file upload/download service with content-type validation and metadata.
