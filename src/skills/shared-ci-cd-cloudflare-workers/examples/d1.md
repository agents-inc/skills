...
> D1 database binding, parameterized SQL queries, batch operations, migrations, and Hono CRUD API. Reference from [SKILL.md](../SKILL.md).
...
## Full CRUD API with Hono + D1

A complete CRUD API backed by D1 with parameterized queries and proper error handling.
