...
function setMultipleTransitionNames(
  ...
  if (elements.container) {
    elements.container.style.viewTransitionName = TRANSITION_NAMES.container(cardId);
  }
}

function clearMultipleTransitionNames(
...
export async function expandCard(cardId: string): Promise<void> {
  ...
  const image = container?.querySelector("[data-card-image]") as HTMLElement | null;
  const title = container?.querySelector("[data-card-title]") as HTMLElement | null;
...
export function openModalFromElement(
  ...
  const updateFn = () => {
    ...
    const modalContentEl = modal.querySelector("[data-modal-content]") as HTMLElement;
    if (modalContentEl) {
...
export function closeModal(): void {
  const modalContentEl = document.querySelector("[data-modal-content]") as HTMLElement;
