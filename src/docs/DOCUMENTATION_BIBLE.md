...
**Reference:** `/src/docs/PROMPT_BIBLE.md`
...
| 3.0.0     | 2025-12-02     | SIMPLIFIED: Removed specific token budgets (premature optimization), replaced with progressive loading principle. Replaced PROMPT_BIBLE technique rewrites with cross-reference to canonical source at `/src/docs/PROMPT_BIBLE.md`. Reduced maintenance overhead.                                                                |
