...
> Full code examples for Vite build configuration. See [SKILL.md](../SKILL.md) for pattern summaries and [reference.md](../reference.md) for decision frameworks.
...
7. **Check esbuild config** - auto-converted to Oxc (`esbuild` option converts to `oxc` option)
