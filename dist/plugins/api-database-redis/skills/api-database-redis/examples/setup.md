# Redis -- Setup & Connection Examples

> Connection setup patterns for ioredis and node-redis. Reference from [SKILL.md](../SKILL.md).
...
Use node-redis only when you need Redis Stack modules (JSON, Search, TimeSeries).
